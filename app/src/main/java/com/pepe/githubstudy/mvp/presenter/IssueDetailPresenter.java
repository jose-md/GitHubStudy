...
import com.pepe.githubstudy.mvp.contract.IIssueDetailContract;
import com.pepe.githubstudy.mvp.model.Issue;
import com.pepe.githubstudy.mvp.model.IssueEvent;
import com.pepe.githubstudy.mvp.model.request.CommentRequestModel;
...
public class IssueDetailPresenter extends BasePresenter<IIssueDetailContract.View>
    ...
    private void initIssueInfo() {
        if (issue != null) {
            ...
            if (!GitHubHelper.isIssueUrl(issueUrl)) {
                return;
            }
    ...
    public void toggleIssueState() {
        ...
        generalRxHttpExecute(getIssueService().editIssue(issue.getRepoAuthorName(),
                ...
                IssueRequestModel.generateFromIssue(issue)), subscriber, null);
    }

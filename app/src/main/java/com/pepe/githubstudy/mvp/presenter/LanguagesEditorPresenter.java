...
import com.pepe.githubstudy.dao.MyTrendingLanguage;
import com.pepe.githubstudy.dao.MyTrendingLanguageDao;
...
import com.pepe.githubstudy.utils.JSONUtils;
        ...
        generalRxHttpExecute(
                new IObservableCreator<ResponseBody>() {
                    ...
                    public io.reactivex.Observable<Response<ResponseBody>> createObservable(boolean forceNetWork) {
                        return getGitHubWebPageService().getTrendingLanguages();
                    }
                },
                httpObserver, false);
    }
        ...
        Observable.just(page)
                ...
                .subscribe(new Action1<Object>() {
                    ...
                    public void call(Object results) {
                        if (results != null) {
                            mView.hideLoading();
                            languages = (ArrayList<TrendingLanguage>) results;
                            for (TrendingLanguage trendingLanguage : languages) {

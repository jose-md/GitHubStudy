...
import com.pepe.githubstudy.mvp.contract.ILanguagesEditorContract;
import com.pepe.githubstudy.mvp.model.TrendingLanguage;
import com.pepe.githubstudy.mvp.presenter.LanguagesEditorPresenter;
import com.pepe.githubstudy.ui.activity.LanguagesEditorActivity;
import com.pepe.githubstudy.ui.adapter.LanguagesAdapter;
...
public class LanguagesEditorFragment extends ListFragment<LanguagesEditorPresenter, LanguagesAdapter>
    ...
    protected void setAdapter() {
        mAdapter = new LanguagesAdapter(getActivity(),this);
    }
    ...
    public void onItemClick(int position, @NonNull View view) {
        ...
        if(LanguagesEditorActivity.LanguageEditorMode.Choose.equals(mPresenter.getMode())){
            boolean selected = mAdapter.getData().get(position).isSelected();
            mAdapter.getData().get(position).setSelected(!selected);
    ...
    public boolean onItemMoved(int fromPosition, int toPosition) {
        TrendingLanguage fromLanguage = mAdapter.getData().remove(fromPosition);
        mAdapter.getData().add(toPosition, fromLanguage);

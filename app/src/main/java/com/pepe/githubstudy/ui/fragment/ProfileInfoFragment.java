...
import com.pepe.githubstudy.mvp.presenter.ProfileInfoPresenter;
...
//                if(mPresenter.getUser().getFollowers() == 0) {
//                    return;
//                }
...
//                if(mPresenter.getUser().getFollowing() == 0) {
//                    return;
//                }
...
//                        mPresenter.getUser().getLogin());
                break;
            case R.id.repos_lay:
//                if(mPresenter.getUser().getPublicRepos() == 0){
//                    return;
//                }

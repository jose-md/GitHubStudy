...
import com.pepe.githubstudy.mvp.presenter.LabelManagePresenter;
import com.pepe.githubstudy.ui.adapter.LabelManageAdapter;
import com.pepe.githubstudy.ui.fragment.base.ListFragment;
import com.pepe.githubstudy.ui.widget.EditLabelDialog;
...
public class LabelManageFragment extends ListFragment<LabelManagePresenter, LabelManageAdapter>
    ...
    protected void setAdapter() {
        mAdapter = new LabelManageAdapter(getActivity(),this);
    }
    ...
    public void onItemClick(int position, @NonNull View view) {
        ...
        new EditLabelDialog(getActivity(), this, mAdapter.getData().get(position)).show();
    }

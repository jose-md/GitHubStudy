...
import com.pepe.githubstudy.ui.widget.colorChooser.ColorChooserPreference;
...
//        findPreference(PrefUtils.LOGOUT).setOnPreferenceClickListener(this);
    ...
    private void showThemeChooser() {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setSingleChoiceItems(R.array.theme_array, selectIndex, new DialogInterface.OnClickListener() {
                    @Override
    ...
    private void showChooseStartPageDialog() {
        new AlertDialog.Builder(getContext())
                ...
                .setSingleChoiceItems(R.array.start_pages_name, getStartPageIndex(), new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
